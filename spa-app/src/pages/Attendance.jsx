...
const Attendance = ({ embedded = false, onDataChange }) => {
  ...
  const handleCameraCapture = async (captureData) => {
    ...
    try {
      ...
      // This page is the manager/receptionist clock-in flow — they can
      // clock any employee in/out — so the actor is almost always
      // different from the employee. The attendance photos modal renders
      // "by Randy Benitua (Owner)" off these fields so the team can
      // tell self-clock from remote-clock at a glance.
                  ...
                  {selectedRecord.clockInPhoto ? (
                    <div className="photo-container">
                      ...
                      <div className="photo-meta">
                        ...
                        {selectedRecord.clockedInBy && (
                          <div className="photo-actor">
                            <span className="meta-label">By:</span>
                            <span className="meta-value">
                              {selectedRecord.clockedInBy}
                              {selectedRecord.clockedInByRole ? ` (${selectedRecord.clockedInByRole})` : ''}
                            </span>
                          </div>
                        )}
                  ...
                  {selectedRecord.clockOutPhoto ? (
                    <div className="photo-container">
                      ...
                      <div className="photo-meta">
                        ...
                        {selectedRecord.clockedOutBy && (
                          <div className="photo-actor">
                            <span className="meta-label">By:</span>
                            <span className="meta-value">
                              {selectedRecord.clockedOutBy}
                              {selectedRecord.clockedOutByRole ? ` (${selectedRecord.clockedOutByRole})` : ''}
                            </span>
                          </div>
                        )}
