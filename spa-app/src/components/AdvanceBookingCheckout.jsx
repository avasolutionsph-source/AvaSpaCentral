                    ...
                    {customers && customers
                      ...
                      .map(customer => (
                        <div
                          ...
                          // focused so the suggestion list isn't unmounted
                          // by the onBlur-scheduled hide before our pick
                          // handler runs. See POS.jsx for the matching
                          // pattern + the bug class this fixes.
                          onMouseDown={(e) => {
                            e.preventDefault();
